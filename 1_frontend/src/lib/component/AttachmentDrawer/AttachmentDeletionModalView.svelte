<script lang="ts">
  ...
  import type { AttachmentStatus as Attachement } from '../../../generated/client';

  export let attachment: Attachement;
  export let onRequestClose: () => void;
  export let onDelete: (attachment: Attachement) => void;
...
<div>
  ...
  <div class="content">
    <p class="content-text">
      Are you sure you want to delete <span class="content-highlight">{attachment.name}</span>?
      <br />This action cannot be undone.
    </p>
  </div>
  <div class="actions">
    <button class="cancel-button" on:click={onRequestClose}>Cancel</button>
    <button class="delete-button" on:click={handleAttachmentDelete}>Delete</button>
  </div>
</div>
