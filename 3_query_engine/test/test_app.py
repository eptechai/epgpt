import grpc
import pytest
from app import QueryEngineService
from query_engine_pb2 import getConvCitationsRequest
...
def grpc_add_to_server():
    from query_engine_pb2_grpc import add_QueryEngineServicer_to_server

    return add_QueryEngineServicer_to_server
