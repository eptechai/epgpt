import grpc
import pytest
from app import ResponseSynthetyzerService
from response_synthesizer_pb2 import getConvCitationsRequest
...
def grpc_add_to_server():
    from response_synthesizer_pb2_grpc import add_ResponseSynthetyzerServicer_to_server

    return add_ResponseSynthetyzerServicer_to_server
...
def grpc_stub(grpc_channel):
    return ResponseSynthetyzerService()
...
async def test_getCitations(
    grpc_stub: ResponseSynthetyzerService,
